...
namespace Jogo_Genius_Simon
{
    public partial class Form1 : Form
    {
        ...
        string corRosaPadrao = "#fc417c";
        string corLaranjaPadrao = "#e13600";


        //Pisacando cor, Quando piscar troca para essa cor
        ...
        string corRosaPiscando = "#fda0bd";
        string corLaranjaPiscando = "#fdc4b2";
        ...
        public Form1()
        {
            ...
            btRosa.BackColor = ColorTranslator.FromHtml(corRosaPadrao);
            btLaranja.BackColor = ColorTranslator.FromHtml(corLaranjaPadrao);
            ...
            btRosa.FlatAppearance.MouseOverBackColor = ColorTranslator.FromHtml(corRosaPadrao);
            btLaranja.FlatAppearance.MouseOverBackColor = ColorTranslator.FromHtml(corLaranjaPadrao);
            ...
            btRosa.FlatAppearance.MouseDownBackColor = ColorTranslator.FromHtml(corRosaPiscando);
            btLaranja.FlatAppearance.MouseDownBackColor = ColorTranslator.FromHtml(corLaranjaPiscando);
            ...
            btRosa.Cursor = Cursors.Hand;
            btLaranja.Cursor = Cursors.Hand;
            ...
            btCiano.Enabled = false;
            btRoxo.Enabled = false;

            btRosa.Enabled = false;
            btLaranja.Enabled = false;
        }
        ...
        private void Piscando()
        {
            ...
            for (int i = 0; i < sequencia.Count; i++)
            {
                ...
                else if (sequencia[i] == btRosa)
                    corPiscando = ColorTranslator.FromHtml(corRosaPiscando);
                else if (sequencia[i] == btLaranja)
                    corPiscando = ColorTranslator.FromHtml(corLaranjaPiscando);
        ...
        private void HabilitaDesabilitaBotao(bool habilita)
        {
            ...
            btRosa.Enabled = habilita;
            btLaranja.Enabled = habilita;
        }
